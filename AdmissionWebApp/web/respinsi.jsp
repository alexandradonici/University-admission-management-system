...
<div style=" margin-top: 40px;   text-align: center;">
    ...
    <p style="font-size:30px; font-family: creta;">Introduceti id-ul specializarii pentru care doriti sa vizionati lista de candidati respinsi</p>
    ...
    <%
        ...
        {
            ArrayList<Repartitie> list = RepartitieService.getInstance().getRespinsi(ids);
            if(list.size() != 0)
            {
