...
<head>
    ...
    <title>Admisi buget</title>
</head>
<body >
<div style=" margin-top: 40px;   text-align: center;">
    <a href="user.jsp"><input type="button"  value="Inapoi la pagina principala"></a>
    <p style="font-size:30px; font-family: creta;">Introduceti id-ul specializarii pentru care doriti sa vizionati lista de candidati admisi la buget</p>
    ...
    <br><br>
        ...
        <%
            ...
            {
                ArrayList<Repartitie> list = RepartitieService.getInstance().getAdmisiBuget(ids);
                if(list.size() != 0)
                {
